...
class InterestRateViewController: UIViewController {
    ...
    @IBOutlet weak var showInterestRate: ShowInteresinterRate!
...
class VndViewController: NSObject, UITableViewDataSource {
...
class UsdViewController: NSObject, UITableViewDataSource {
...
class EurViewController: NSObject, UITableViewDataSource {
    var monthAndrate = [ Interestrate(month: "Không kỳ hạn", rate: 0.00),
                         Interestrate(month: "7 ngày", rate: 0),
                         Interestrate(month: "14 ngày", rate: 0),
